    ...
    <div class="scrollbar-inner">
        ...
        <div class="sidenav-header d-flex align-items-center">
            <a class="navbar-brand" href="">
                <img src="{{asset('assets/img/brand/black.png')}}" class="navbar-brand-img" alt="...">
            </a>
            <div class="ml-auto">
                <!-- Sidenav toggler -->
                ...
                <ul class="navbar-nav align-items-center ml-auto ml-md-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="media align-items-center nav-link dropdown-toggle">
                  <span class="avatar avatar-sm rounded-circle">
                    <!--<img alt="Image placeholder" src="{{asset('assets/img/theme/team-4.jpg')}}">-->
                      <img alt="User avatar" src="{{ $user->profilepicture_filename}}">
                  </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="#" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="ni ni-user-run"></i><span>Logout</span></a>
